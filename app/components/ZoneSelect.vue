...
<template>
  <label class="block" for="zone">
    ...
    <div class="relative">
      <select
        id="zone"
        class="w-full appearance-none rounded-lg border border-white/20 bg-emerald-700 px-3 py-2.5 pr-9 text-base text-white shadow-sm focus:border-white/40 focus:outline-none focus:ring-1 focus:ring-white/40 disabled:cursor-not-allowed disabled:opacity-60"
        :value="modelValue"
        :disabled="loading"
        @change="onChange"
      >
